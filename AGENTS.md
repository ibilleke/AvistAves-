...
- **Leer la documentación oficial antes de implementar un paquete**: antes
  de instalar o usar una librería/paquete nuevo (o una API nueva de uno ya
  instalado, ej. `expo-camera`, `expo-location`, NativeWind, Expo Router),
  revisar su documentación oficial (README, docs del sitio o de la versión
  instalada) para usar la API vigente para la versión del proyecto (SDK 54)
  y evitar patrones deprecados o incompatibles.
